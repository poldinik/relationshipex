...
public final class AuthenticationTokenDetails {
    ...
    private AuthenticationTokenDetails(String id, String email, Set<Authority> authorities, ZonedDateTime issuedDate, ZonedDateTime expirationDate, int refreshCount, int refreshLimit) {
        this.id = id;
        this.email = email;
    ...
    public static class Builder {
        ...
        public AuthenticationTokenDetails build() {
            return new AuthenticationTokenDetails(id, email, authorities, issuedDate, expirationDate, refreshCount, refreshLimit);
        }
    }
}
